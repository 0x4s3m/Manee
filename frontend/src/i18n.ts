export const translations: any = {
  en: {
    ...
    // Notify settings (pause + severity)
    notifySettings: "Notification settings",
    minSeverity: "Send emails for severity ≥",
    pauseEmails: "Pause emails",
    pauseFor5min: "5 min",
    pauseFor1hour: "1 hour",
    pauseFor24hours: "24 hours",
    pauseForever: "Forever",
    resumeEmails: "Resume",
    paused: "Paused",
    notPaused: "Active",
    ...
    // Chat
    chat: "SOC Analyst",
    chatNotConfigured: "Set HUSN_DEEPSEEK_KEY in /etc/systemd/system/husn-backend.service.d/ to enable.",
    askAnything: "Ask anything about your security state...",
    send: "Send",
    reset: "Reset chat",
    thinking: "Thinking...",
  ...
  ar: {
    ...
    userInvalid: "اسم المستخدم وكلمة المرور (8 أحرف على الأقل) مطلوبة",
    ...
    whitelistHelp: "لا يتم حظرها أبدًا. أضف عنوان جهازك، أنظمة المراقبة، البوابة، إلخ.",
    ...
    notifySettings: "إعدادات التنبيهات",
    minSeverity: "إرسال البريد عند خطورة ≥",
    pauseEmails: "إيقاف البريد",
    pauseFor5min: "5 دقائق",
    pauseFor1hour: "ساعة",
    pauseFor24hours: "24 ساعة",
    pauseForever: "للأبد",
    resumeEmails: "استئناف",
    paused: "متوقف",
    notPaused: "نشط",

    chat: "محلل SOC",
    chatNotConfigured: "اضبط HUSN_DEEPSEEK_KEY في /etc/systemd/system/husn-backend.service.d/ لتفعيله.",
    askAnything: "اسأل أي شيء عن حالة الأمان...",
    send: "إرسال",
    reset: "مسح",
    ...
    hour: "الساعة",
    weekday: "اليوم",
    runReportNow: "أنشئ الآن",
    pastReports: "تقارير سابقة",
    download: "تحميل",
    ...
    featuresExtracted:  "الـ ١٧ ميزة المستخدمة",
    flowSummary:        "التدفق",
    inspect:            "افحص",
